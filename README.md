...
//    bool blocked=false;
    ...
    // --- thresholds  ---
       const int FRONT_TH = 320;   // head-on detection threshold
       const int SIDE_TH  = 250;   // side obstacle detection threshold
